...
export function Footer() {
  ...
  const secteurs = [
    ...
    // effectivement des biens, plutôt que vers une page portant le nom d'une
    // commune sans rien à montrer :
    ...
    //   Côte d'Azur → la liste des biens, car les trois secteurs définis
    //   couvrent le Var — Fréjus, Saint-Tropez, Estérel — alors que les
    //   annonces sont à Cannes, Nice, Antibes et Le Rouret : aucun secteur ne
    //   leur correspond, tous affichent zéro bien.
    { href: "/secteurs/paris-centre-historique", label: "Paris" },
    { href: "/immobilier", label: "Côte d'Azur" },
  ];
